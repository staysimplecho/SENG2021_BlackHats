      ...
      <div class="contact-middle-container">
        <div class="title">
          <div id="comp-j9sf5fw9inlineContent-gridContainer">
                      ...
                      <div class="style-jckajvkwlink">
                        ...
                        >
                          <svg
                            ...
                            data-bbox="17.3 68.2 165.3 63.6"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="17.3 68.2 165.3 63.6"
                            role="img"
                          >
                            <g>
            ...
            <!--black tilt line-->
            <div
              data-svg-id="0dc8050383f4475f867f63ef8f5f2599.svg"
              data-svg-type="shape"
              data-display-mode="stretch"
              data-strokewidth="0"
              data-viewbox="0 0 200 200"
        ...
        <div class="address">
          <div
            style="width: 237px; pointer-events: none;margin:0 0 0 210px;"
            id="comp-j9sd1jhq"
          >
            <h2 class="font_5">
              <span class="color_11">
...
.white-box {
  border: 0px solid rgba(248, 246, 0, 1);
